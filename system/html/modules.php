...
{ ?>
		<?php echo "\n<!-- Mod: " . $module->title . " - Type: " . $module->module . " - ID: " . $module->id . " -->"; ?> 
	<table style="padding:0px;border-collapse:collapse;border-spacing:0px" class="moduletable<?php echo $params->get('moduleclass_sfx'); ?>">
...
{ ?>
		<?php echo "\n<!-- Mod: " . $module->title . " - Type: " . $module->module . " - ID: " . $module->id . " -->"; ?> 
	<table style="border-collapse:collapse;border-spacing:1px;padding:0px;border:0px;width:100%">
		<tr>
