...
<table style="width:100%;border:0px;border-collapse:collapse; border-spacing:0px;padding:0px" class="contentpaneopen<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
