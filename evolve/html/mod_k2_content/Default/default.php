...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul class="widget-tabs">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>" style="background: inherit;">
      ...
      <?php $menu_item_id = $params->get('itemCustomLinkMenuItem',150); ?>
      <?php if($params->get('itemTitle')): ?>
      <a class="moduleItemTitle" href="<?php echo 'index.php?option=com_k2&view=item&id='.$item->id.':'.$item->alias ?>&Itemid=<?php echo $menu_item_id; ?>"><?php echo $item->title; ?></a>
      
      <?php endif; ?>
      <?php if($params->get('itemDateCreated')): ?>
      <span style="display: block;" class="moduleItemDateCreated"><?php //echo JText::_('K2_WRITTEN_ON') ; ?> <?php echo JHTML::_('date', $item->created, 'F jS, Y'); ?></span>
      <?php endif; ?>
      </div>
      ...
      <div class="moduleItemIntrotext widget-thumb" style="float: left; width: 30%;">
	      ...
	      <?php }else{ ?>
          <a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
	      	<img src="<?php echo JURi::root().'modules/mod_stslider/assets/images/no-image.png'; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>"/>
	      </a>
          <?php } ?>
