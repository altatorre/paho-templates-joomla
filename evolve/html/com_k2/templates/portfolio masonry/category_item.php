...
<div class=" group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="portfolio-item-alt">
	  ...
	  <?php if($this->item->params->get('catItemImage') && (!empty($this->item->image) || !empty($this->item->video))): ?>
        <!-- Item Image -->
        <figure>
         <div class="mediaholder" <?php if (!empty($this->item->video)) echo 'style="width:100%;"'; ?>> 
            <a class="mfp-gallery" href="<?php echo $this->item->image; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
        	   <?php if ($this->item->image !== ""){ ?>
               <img width='<?php echo $this->item->imageWidth; ?>' height='' class="brd-rd2" src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" <?php echo $this->item->port_style_img; ?> />
        ...
        <figcaption class="item-description" style="display: none;">
            <a href="<?php echo $this->item->link; ?>" style="float: left;">
            <h5>
            <?php if($this->item->params->get('catItemTitle')): ?>
            	  <!-- Item title -->
            	  	...
            	  	<?php endif; ?>
                    <?php endif; ?>
            </h5></a><i class="ss-heart"> 20</i> 
            <span style="clear: both;display: block;">
                 <?php if($this->item->params->get('catItemIntroText')): ?>
                    <!-- Item introtext -->
                    <?php echo substr(strip_tags($this->item->introtext),0,30).' [...]'; ?>
                    <?php endif; ?>
            </span> 
