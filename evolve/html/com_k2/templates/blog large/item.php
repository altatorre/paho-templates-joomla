...
<div class="post">
    <figure class="post-img media">
        <?php if($this->item->params->get('catItemImage') && (!empty($this->item->image) || !empty($this->item->video) )){ ?>
       <div style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;"  class="mediaholder" <?php if (!empty($this->item->video)) echo 'style="width:102%;"'; ?>> 
        ...
        <?php }else if($this->item->params->get('catItemExtraFields') && count($this->item->extra_fields) ) { ?>
    	  <!-- Item extra fields -->
     ...
     <?php if($this->item->params->get('catItemDateCreated')): ?>
      ...
      <?php endif; ?>
    <section class="post-content" style="margin: -105px 0 0 95px;">
        <header class="meta">
          <ul>
               <li>
                    <a href="#">
