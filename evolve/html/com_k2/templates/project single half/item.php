...
<div class="post" style="border-bottom: 0; padding: 0; margin: 0;">
    <div class="eleven alt columns">
        ...
        <?php if($this->item->params->get('catItemExtraFields') && count($this->item->extra_fields)  && ($this->item->extra_fields != '[]')) { 
        ...
        ?>
    	  ...
    	  <div class="media">
    	  	...
    	  	<ul class="slides mediaholder stk2-slider">
    			<?php foreach (json_decode($this->item->extra_fields) as $key=>$extraField):$extraField->type ='' ?>
    			...
    			<li class="<?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
    				<a class="mfp-gallery" href="#"> 
        				...
        				<span class="catItemExtraFieldsValue"><img src="<?php echo JURi::root().$extraField->value; ?>" /></span>
        				<?php endif; ?>
        ...
        <?php }else if($this->item->params->get('catItemImage') && (!empty($this->item->image) || !empty($this->item->video) )){ ?>
       <div class="mediaholder" <?php if (!empty($this->item->video)) echo 'style="width:102%;"'; ?> style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" > 
            <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
        	   <?php if ($this->item->image !== ""){ ?>
               <img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" width='<?php echo $this->item->imageWidth; ?>' height='' />
        
               
               <?php }elseif($this->item->params->get('itemVideo') && !empty($this->item->video)){ ?>
                  <!-- Item video -->
                  <div class="">
     ...
     <?php if($this->item->params->get('catItemDateCreated')): ?>
      <div class="post-format">
         <h4><?php echo strtoupper(date('M',strtotime($this->item->created))); ?></h4>
         <h2><?php echo date('d',strtotime($this->item->created)); ?></h2>
         <span><i class="ss-heart"></i>
      ...
      <?php endif; ?>
    <section class="five columns" style="margin-top: -30px;">
        <header class="meta">
          <ul>
               <li>
                    <a href="#">
  ...
  <hr class="sep50">
	<div class="itemRelated">
        <div style="margin-left: 10px;">
            <h3 class="headline"><?php echo JText::_("Related Projects"); ?></h3>
            <span class="brd-headling"></span>
            <div class="clearfix"></div>
        </div>
		<ul>
			<?php foreach($this->relatedItems as $key=>$item): ?>
			<li class="four columns portfolio-item media">
                <div class="mediaholder"> <a href="<?php echo $item->image; ?>" class="mfp-image" title="<?php echo $item->name; ?>"> 
                    <?php if($this->item->params->get('itemRelatedImageSize')): ?>
    				<img style="width:100%;height:auto;" class="itemRelImg" src="<?php echo $item->image; ?>" alt="<?php K2HelperUtilities::cleanHtml($item->title); ?>" />
    				<?php endif; ?>
                       <div class="hovercover" style="opacity: 0;">
                            <div class="hovericon" style="top: 50%; opacity: 1;"><i class="hoverzoom"></i></div>
                       </div>
                    </a>
                </div>
                <figcaption class="item-description">
                    <div style="float: left;">
        				...
        				<span class="" style="display: block;"><?php echo substr(strip_tags($item->introtext),0,25); ?></span>
        				<?php endif; ?>
                    </div>
    				<i class="ss-heart"> <?php echo $item->hits; ?></i>
                </figcaption>
...
<div id="k2Container" class="<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <?php endif; ?>
		...
		<div class="itemContentFooter" style="border: none;">
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="twelve alt columns">
      ...
      <h3 class="headline">
         ...
         <span class="comments-amount">(<?php echo $this->item->numOfComments; ?> <i class="icon-comment-alt"></i>)</span>
	  </h3>
      <span class="brd-headling"></span>
      <div class="clearfix"></div>
      <section class="comments-sec">
    	  <ul class="commentlist">
    	    ...
    	    <li class="comment <?php //echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
                ...
                <div class="comment-des">
                    ...
                    <div class="comment-by">
                        ...
                        <span>-</span>
                        <span class="commentDate" style="display: block;">
