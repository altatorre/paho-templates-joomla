  ...
  <div class="post">
	  ...
	  <?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>
        ...
        <figure class="post-img media">
         <div class="mediaholder" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;"> <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
        	<img width='<?php echo $this->item->imageWidth; ?>' height='' src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"  />
      ...
      <section class="">
            ...
            <?php echo substr($this->item->introtext,0,550).' [...]'; ?>
            </div>
            <?php endif; ?>
            <div class="clr"></div>
