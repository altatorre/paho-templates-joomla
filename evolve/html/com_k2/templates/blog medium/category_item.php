...
<div class=" group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="post medium">
	  ...
	  <?php if($this->item->params->get('catItemImage') && (!empty($this->item->image) || !empty($this->item->video))){ ?>
        ...
        <div class="five alt columns alpha">
            <figure class="post-img media">
             <div class="mediaholder" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;"> 
                <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
            	       <section class="date">
                        <?php if($this->item->params->get('catItemDateCreated')): ?>
                         <span class="day"><?php echo strtoupper(date('d',strtotime($this->item->created))); ?></span>
                         <span class="month"><?php echo date('M',strtotime($this->item->created)); ?></span>
               ...
               <?php }elseif($this->item->params->get('itemVideo') && !empty($this->item->video)){ ?>
                  ...
                  <div class="">
                  	<h3><?php // echo JText::_('K2_MEDIA'); ?></h3>
                		...
                		<div class="itemVideoEmbedded" style="width: 320px; height: 240px;">
	  ...
	  <?php }else  if($this->item->params->get('catItemExtraFields') && count($this->item->extra_fields) ) { ?>
    	  <!-- Item extra fields -->
          <section class="flexslider post-img five alt columns alpha">
    	  <div class="media">
    	...
    	<?php endif; ?>
         <div class="seven columns">
          <section class="">
                ...
                <?php echo substr($this->item->introtext,0,500).' [...]'; ?>
                </div>
                <?php endif; ?>
                <div class="clr"></div>
