	...
	<div class="itemList">
        ...
        <div class="container">
            <div class="sixteen columns main-headline">
               ...
               <p><?php echo JText::_('TPL_EVOLVE_PORTFOLIO_THREE_COLUMNS'); ?></p>
            </div>
            <hr class="sep20">
		...
		<div id="portfolio-wrapper">
			...
			<div class=" one-third column portfolio-item media <?php echo $lastContainer; ?> <?php echo  strtolower(str_replace(' ','',$item->category->name).$item->category->id); ?>">
				<?php
