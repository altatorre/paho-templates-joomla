	  ...
	  <?php if($this->item->params->get('catItemImage') && (!empty($this->item->image) || !empty($this->item->video))): ?>
        ...
        <figure>
         <div class="mediaholder" <?php if (!empty($this->item->video)) echo 'style="width:102%;"'; ?>> 
            <a class="mfp-image" href="<?php echo $this->item->image; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
        	   <?php if ($this->item->image !== ""){ ?>
               <img width='380' height='272' src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
