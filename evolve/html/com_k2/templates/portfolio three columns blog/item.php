...
<div class="post" style="border-bottom: 0; padding: 0; margin: 0;">
    <div class="eleven alt columns">
        <figure class="post-img media">
         <div style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" class="mediaholder"> <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
	...
	<div class="itemRelated">
		...
		<ul>
			...
			<li class="four columns portfolio-item media">
                <div class="mediaholder"> <a href="images/content/portfolio-01a.jpg" class="mfp-image" title="Project 01"> 
