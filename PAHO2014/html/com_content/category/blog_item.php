...
<?php $pgsfx = $this->escape($this->item->params->get( 'pageclass_sfx' )); ?>
<?php if (!$this->item->text) { return; } ?>
...
<!-- esta div mostra o título de cada item 'leading' e 'intro' -->
<div class="contentpaneopen" id="titulo">
	<?php if ($this->item->params->get('show_title')) : ?>
	<div class="contentheading<?php echo $pgsfx; ?>">
...
<!-- fim da div que mostra o título de cada item 'leading' e 'intro' -->
<?php endif; ?>
...
<!-- esta table mostra o introtext de cada item 'leading' e 'intro' -->
<table class="contentpaneopen<?php echo $this->escape($this->item->params->get( 'pageclass_sfx' )); ?>" style="">
...
<span class="article_separator" style="font-size:3px"></span>
<?php } ?>
