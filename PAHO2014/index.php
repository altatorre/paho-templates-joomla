...
<div id="wrapper">
	...
	<?php // echo '<a name="content" id="content"></a>'; por validacion se quitó ?>
	...
	<?php
		...
		<div id="rss_left_fp"><jdoc:include type="modules" name="innerleft" style="xhtml" /></div><!-- rss_left -->
		<div id="rss_center_fp"><jdoc:include type="modules" name="innercenter" style="xhtml" /></div><!-- rss_center -->
		<div id="rss_right_fp"><jdoc:include type="modules" name="innerright" style="xhtml" /></div><!-- rss_right -->
