...
function modChrome_yoo($module, &$params, &$attribs) {
	...
	if ($suffix == '') {
		if ($module->position == 'header') $suffix = 'roundedtrans';
		if ($module->position == 'top') $suffix = 'grey';
		if (($module->position == 'top-equal') || ($module->position == 'top-goldenratio')) $suffix = 'grey';
		if ($module->position == 'left') $suffix = 'hover';
		if ($module->position == 'right') $suffix = 'hover';
		if (($module->position == 'main-top-equal') || ($module->position == 'main-top-goldenratio')) $suffix = 'border';
		if (($module->position == 'content-top-equal') || ($module->position == 'content-top-goldenratio')) $suffix = 'tab';
		if (($module->position == 'content-bottom-equal') || ($module->position == 'content-bottom-goldenratio')) $suffix = 'tab';
		if (($module->position == 'main-bottom-equal') || ($module->position == 'main-bottom-goldenratio')) $suffix = 'border';
		if (($module->position == 'bottom-equal') || ($module->position == 'bottom-goldenratio')) $suffix = 'grey';
		if ($module->position == 'bottom') $suffix = 'grey';
	}

	// force module type
	if ($module->position == 'toolbar')  $suffix = 'blank';
	if ($module->position == 'header')  $suffix = 'roundedtrans-header';
	...
	switch ($skeleton) {
		...
		case '0-2n-0':
			/*
			 * module skeleton with 2 div structure
			 * usage: border
			 *
			 * 2n: 2 nested divs
			 */
