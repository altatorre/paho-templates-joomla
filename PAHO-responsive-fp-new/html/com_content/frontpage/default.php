...
?>
		<div class="noticias_intro">
			<h2 class="news entry-title"><a href="index.php?option=com_content&amp;view=article&amp;id=<? echo $items[$i]->slug; ?>&amp;Itemid=1926" rel="bookmark" title=""><?php echo $items[$i]->title; ?></a></h2>
			<div class="newstext"><?php echo $items[$i]->introtext; ?></div>
			<div class="newsrm"><a href="index.php?option=com_content&amp;view=article&amp;id=<? echo $items[$i]->slug; ?>&amp;Itemid=1926" rel="bookmark" title=""><?php echo JText::_("Read more...",$jsSafe = true); ?></a></div>
...
<?php
	...
	if ($i >= $intro) {
?>
			<p class="noticias_links"><a href="index.php?option=com_content&amp;view=article&amp;id=<? echo $items[$i]->slug; ?>&amp;Itemid=1926" rel="bookmark" title=""><?php echo $items[$i]->title; ?></a></p>
<?php
	}
}	// End of foreach loop
?>
