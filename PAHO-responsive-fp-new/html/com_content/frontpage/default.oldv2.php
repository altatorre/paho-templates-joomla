...
?>
			<div class="noticia<? echo $lado; ?>">
				<h2 class="news entry-title"><a href="index.php?option=com_content&amp;view=article&amp;id=<? echo $row->slug; ?>&amp;Itemid=1926" rel="bookmark" title=""><?php echo $row->title; ?></a></h2>
				...
				?>
				<div class="newsrm"><a href="index.php?option=com_content&amp;view=article&amp;id=<? echo $row->slug; ?>&amp;Itemid=1926" rel="bookmark" title=""><?php echo JText::_("Read more...",$jsSafe = true); ?></a></div>
			</div><!-- .noticia -->
<?php
$i++;
} ?>
