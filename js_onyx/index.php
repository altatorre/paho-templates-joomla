...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
	<head>
		...
		<link href="<?php echo JUri::base(); ?>templates/js_onyx/css/style-<?php echo $style; ?>.css?v=6" rel="stylesheet" type="text/css" />
		<link href="<?php echo JUri::base(); ?>templates/js_onyx/css/joomla30-<?php echo $style; ?>-extended.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo JUri::base(); ?>templates/js_onyx/css/joomla30-<?php echo $style; ?>-responsive.css?v=1" rel="stylesheet" type="text/css" />
...
<?php } ?>
      ...
      <?php
		...
		?>
			...
			<?php
				$db = &JFactory::getDBO();
				$query = "SELECT * FROM #__modules WHERE `position`='footer' AND `client_id`=0 AND `published`=1 ORDER BY ordering";
				$db->setQuery($query);
				$results = $db->loadObjectList();
				$span = (12/count($results));
				for ($i=0;$i <count($results);$i++) {
