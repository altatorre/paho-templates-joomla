...
<div>
	...
	<div class="contentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" style="width:100%">
		<h1 class="contentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>"><?php 
	...
	<?php if (!$this->print) : ?>
		...
		<div style="text-align:right;width:100%" class="buttonheading">
