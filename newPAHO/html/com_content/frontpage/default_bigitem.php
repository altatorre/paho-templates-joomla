...
<h2 style="display: block;width:570px;padding: 5px;margin:0;background-color: #258">
	<?php if ($this->item->params->get('link_titles') && $this->item->readmore_link != '') : ?>
	<a href="<?php echo $this->item->readmore_link . '&amp;Itemid=1926'; ?>" style="text-decoration: none;color: #FFF;font-size: 13px;font-weight: bold">
...
echo '<img style="border-left:1px solid #999;border-right:1px solid #999" src="'.$imagem.'" height="310" width="578" /><br />';
$texto = $this->item->introtext;
$texto = strip_tags($texto, '<strong><em><a><iframe>');
echo '<div style="width: 572px;background-color:#EEE;padding:3px;margin-top: -4px;border:1px solid #999;border-bottom: 0"><p>' . $texto;
echo '</p></div>';
?>
...
<?php if ($this->item->params->get('show_readmore') && $this->item->readmore) : ?>
	<?php echo '<div style="background-color: #EEE;border:1px solid #999;border-top:0;width:572px;padding: 3px">'; ?>
