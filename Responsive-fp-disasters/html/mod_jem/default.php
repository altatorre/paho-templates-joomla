...
?>
<div class="jemmodframe">
<h3>Activities Calendar on Health Emergencies</h3>
<?php if (count($items)): ?>
<ul class="jemmod<?php echo $params->get('moduleclass_sfx'); ?>">
	<?php foreach ($list as $item) : ?>
	<li class="jemmod<?php echo $params->get('moduleclass_sfx'); ?>"><strong><?php echo $item->city; ?></strong>
