...
<div id="wrapper">
	<div id="access">
		...
		<div id="menus">
			...
			<div id="open_close_menu">
				<jdoc:include type="modules" name="dc-menu" />
	...
	<div id="main">
		<div id="content-2"<?php if (!$this->countModules( 'dc-right' )) { echo ' style="width: 100%"'; } ?>><!-- content -->
...
<?php } ?>
			...
			<div id="ct_left-1">
				<jdoc:include type="modules" name="dc-left1" style="xhtml" />
			</div><!-- end of #ct_left-1 -->

			<div id="ct_left-2">
				<jdoc:include type="modules" name="dc-left2" style="xhtml" />
...
<?php if ($this->countModules( 'dc-right' )) { ?>
		<div id="ct_right">
			<jdoc:include type="modules" name="dc-right" style="xhtml" />
		</div><!-- end of #ct_right -->
<?php } ?>
	</div><!-- #main -->
