...
<?php
	if (property_exists($row, 'image')) {  
		$bigdiv .= "\t".'<div class="fp_slsh_foto"><div style="position:relative"><a href="' . $row->link . '"><img src="' . $row->image . '" alt="' . substr($row->title,0,50) . '..." /></a><div class="mascara"><img src="/hq/images/stories/mascara.png" alt=" " /></div></div>'."\r\n".
	...
	if ($row->flag) { $img_margin = '_margin'; }
		$bigdiv .= "<div class=\"fp_slsh_foto".$img_margin."\"><div style=\"position:relative\"><img src=\"" . $row->thumb . "\" alt=\"" . substr($row->title,0,50) . "...\" /><div class=\"mascara".$img_margin."\"><img src=\"/hq/images/stories/mascara.png\" alt=\" \" /></div>"."\r\n".
		"<div class=\"fp_slsh_play".$img_margin."\"><a href=\"" . $row->ytlink . "\" class=\"html5lightbox\"><img src=\"modules/".$module->module . "/images/yt_play-600.png\" style=\"border: none\" alt=\"Play\" /></a></div><!-- end of .fp_slsh_play --></div><!-- end of .fp_slsh_foto --></div>"."\r\n".
		""."\r\n".
		"<div class=\"fp_slsh_texto\">"."\r\n".
		"<div class=\"sl_texto\"><a href=\"" . $row->link . "\"><h2>" . $row->title . "</h2></a><p><a href=\"" . $row->link . "\">" .  JText::_("Watch video...",$jsSafe = true) . "</a></p></div><!-- end of .sl_texto --></div>"."\r\n"."<!-- end of .fp_slsh_texto -->\r\n";
		$img_margin = '';
	}
}
echo "</script>\n";
if (property_exists($detalhes[0], 'image')) {  
	$bigdiv .= '<div class="fp_slsh_foto"><div style="position:relative"><img src="' . $detalhes[0]->image . '" alt="'.substr($detalhes[0]->title,0,50) . '..." /><div class="mascara"><img src="/hq/images/stories/mascara.png" alt=" " /></div></div><!-- end of .fp_slsh_foto --></div>'."\r\n".
	'<div class="fp_slsh_texto">'."\r\n".
...
if(property_exists($detalhes[0], 'video')) {
	if ($detalhes[0]->flag) { $img_margin = '_margin'; }
		$bigdiv .= "<div class=\"fp_slsh_foto".$img_margin."\"><div style=\"position:relative\"><img src=\"" . $detalhes[0]->thumb . "\" alt=\"" . substr($detalhes[0]->title,0,50) . "...\" /><div class=\"mascara".$img_margin."\"><img src=\"/hq/images/stories/mascara.png\"  alt=\" \" /></div><div class=\"fp_slsh_play".$img_margin."\"><a href=\"" . $detalhes[0]->ytlink . "\" class=\"html5lightbox\"><img src=\"modules/".$module->module . "/images/yt_play-600.png\" style=\"border: none\" alt=\"Play\" /></a></div><!-- end of .fp_slsh_play --></div><!-- end of .fp_slsh_foto --></div>"."\r\n".
		""."\r\n"."<div class=\"fp_slsh_texto\">"."\r\n".
...
<?php
		echo "<div id=\"circle0\" class=\"color-circle-b\"><a style=\"outline: none;border:none\" href=\"javascript:ssGoto('0',this);\"><img src=\"" . JURI::base() . "modules/" . $mainframe->scope . "/images/null.gif\" width=\"11\" alt=\"slide 0\" style=\"border:0px\" /></a></div>";
	for ($i=1; $i < count($detalhes); $i++) {
		echo "<div id=\"circle" . $i . "\" class=\"color-circle\"><a style=\"outline: none;border:none\" href=\"javascript:ssGoto('$i', this);\"><img src=\"" . JURI::base() . "modules/" . $mainframe->scope . "/images/null.gif\" width=\"11\" alt=\"slide $i\" style=\"border:0px\" /></a></div>";
	}
	?>
</div><!-- end of #circles -->
</div><!-- end of #sld_crc -->
