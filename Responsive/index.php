...
<?php 
//$doc->addScript($JUribase . 'media/system/js/language.js');
//$doc->addScript($JUribase . 'media/jui/js/jquery.min.js', 'text/javascript');
//$doc->addScript($JUribase . 'media/jui/js/jquery-noconflict.js', 'text/javascript');
//$doc->addScript($JUribase . 'media/jui/js/jquery-migrate.min.js', 'text/javascript');
	?>
