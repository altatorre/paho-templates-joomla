...
<table class="eventtable" width="<?php echo $this->elsettings->tablewidth; ?>" style="border:0px;border-collapse:collapse;border-spacing:0px;padding:0px" summary="venues list">
	<thead>
		<tr>
