...
<table style="width:100%;border:0px;border-collapse:collapse; border-spacing:0px;padding:0px">
...
<tr>
	...
	<td  style="text-align:center" class="sectiontableheader<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" width="5%" nowrap="nowrap">
