...
<h2 style="display: block;width: 468px;font-size: 13px;padding: 6px;margin:0;background-color: #258">
	<?php if ($this->item->params->get('link_titles') && $this->item->readmore_link != '') : ?>
	<a href="<?php echo $this->item->readmore_link . '&amp;Itemid=1926'; ?>" style="color: #FFF">
...
echo '<img style="border-left:1px solid #999;border-right:1px solid #999" src="'.$imagem.'" /><br />';
$texto = $this->item->introtext;
$texto = strip_tags($texto, '<strong><em><a><iframe>');
echo '<div style="width: 472px;background-color:#EEE;padding:3px;margin-top: -2px;border:1px solid #999;border-bottom: 0"><p>' . $texto;
echo '</p></div>';
?>
