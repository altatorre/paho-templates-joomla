...
<?php endif; ?>
<table  style="text-align:center;width:100%;padding:0px;border-collapse:collapse;border-spacing:0px;border:0px" class="contentpane<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
<tr>
