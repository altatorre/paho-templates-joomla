...
<!-- esta table mostra o título de cada item 'leading' e 'intro' -->
<table class="contentpaneopen<?php echo $this->escape($this->item->params->get( 'pageclass_sfx' )); ?>" id="titulo">
<tr>
...
<!-- fim da table que mostra o título de cada item 'leading' e 'intro' -->
<?php endif; ?>
