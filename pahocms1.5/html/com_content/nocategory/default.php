...
<?php endif; ?>
<table style="width:100%;padding:0px;border-collapse:collapse;border-spacing:0px;border:0px;text-align:center" class="contentpane<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
<tr>
