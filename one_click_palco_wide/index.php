...
<link href="<?php echo $mosConfig_live_site;?>/templates/one_click_palco_wide/css/template_css.css" rel="stylesheet" type="text/css" />
						...
						<?php if ( mosCountModules ('banner') ) { ?>
			  				<table border="0" cellpadding="0" cellspacing="0"  width="1024">
								<tr>
									...
									<td align="center" style="border-width:1px;border-right-style:solid;border-color:silver">
									<?php 
                                        //echo _SEARCH_TITLE;  
