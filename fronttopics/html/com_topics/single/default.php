...
<!--	<div class="item col-md-4 text-holder"> -->
		<?php 	
				$mod_right = str_replace("moduletable", "item ", $mod_right);
				echo $mod_right; 
		?>
<!-- 	</div> -->
<?php endif; ?>					
<?php $mod_right = JHTML::_('content.prepare', '{loadposition right1}');
if($mod_right): ?>
<!--	<div class="item col-md-4 text-holder"> -->
		<?php 	
				$mod_right = str_replace("moduletable", "item ", $mod_right);
...
<!-- 	</div> -->
<?php endif; ?>					
<?php $mod_right = JHTML::_('content.prepare', '{loadposition right2}');
if($mod_right): ?>
<!--	<div class="item col-md-4 text-holder"> -->
		<?php 	
				$mod_right = str_replace("moduletable", "item ", $mod_right);
...
<!-- 	</div> -->
<?php endif; ?>	
<?php $mod_right = JHTML::_('content.prepare', '{loadposition right4}');
if($mod_right): ?>
<!--	<div class="item col-md-4 text-holder"> -->
		<?php 	
				$mod_right = str_replace("moduletable", "item ", $mod_right);
