...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<div class="btn-toolbar">
		<div class="btn-group pull-left">
			...
			<button type="submit" name="Search" onclick="this.form.submit()" class="btn btn-default" title="<?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?>"><?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?></button>
		</div>
