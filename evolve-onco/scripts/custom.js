...
================================================== */
	...
	if(stickyheader == true) {
		...
		$("#header-evolve").css({ position: "fixed"});
		var stickyValue = defaultHeight - 20;
		stickyPosition(-stickyValue, null, "#header-evolve");
				...
				if (offset > 60) { // if it is over 60px (the initial width)
					if (!header.hasClass('compact')) {
						header.animate({
								...
								complete: function () {
									...
									$("#header-evolve .topbar").css({ display: "none"});
									$("#header-evolve").css({ opacity: "0.95"});
									$("#header-evolve .search-button").css({ position:"absolute",top: "20px"});
					...
					header.animate({
							...
							complete: function () {
								...
								$("#header-evolve .topbar").css({ display: "block"});
								$("#header-evolve").css({ opacity: "1"});
								$("#header-evolve .search-button").css({ position:"absolute",top: "40px"});
							}
						});
					searchform.animate({
		...
		$(window).resize(function (){
			...
			if(winWidth < 767) {
				 $('#logo').css('marginTop','');
				 $('#header-evolve').css('height','').removeClass('compact');
				 $("#header-evolve").css({ position: ""});
				 $('.menu ul > li > a').css({
					'paddingTop' : '',
					'paddingBottom' : '',
				 });
				...
				stickyPosition(null, null, "#header-evolve");
...
/* 04 Header Search
================================================== */
     var searchBtn = $('#header-evolve-search-button'),
			searchPanel = $('#header-evolve-search-panel'),
			searchP = $('#header-evolve-search'),
