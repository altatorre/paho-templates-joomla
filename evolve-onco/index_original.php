...
if ($compress_css == true) {
	$doc->addStyleSheet(JUri::base(true) . '/templates/' . $this->template . '/css/css-compress.php');
} else {
	$doc->addStyleSheet(JUri::base(true) . '/templates/' . $this->template . '/css/bootstrap.css?v=5');
	$doc->addStyleSheet(JUri::base(true) . '/templates/' . $this->template . '/css/font-awesome.min.css');
	$doc->addStyleSheet(JUri::base(true) . '/templates/' . $this->template . '/css/font-awesome.css');
	$doc->addStyleSheet(JUri::base(true) . '/templates/' . $this->template . '/css/main.css?v=7');
	$doc->addStyleSheet(JUri::base(true) . '/templates/' . $this->template . '/css/custom.css?v=2');
	$doc->addStyleSheet(JUri::base(true) . '/templates/' . $this->template . '/css/paho.css?v=1');
	$doc->addStyleSheet(JUri::base(true) . '/templates/' . $this->template . '/css/impl.css?v=3');
}

//$doc->addScript(JUri::base(true) . '/templates/' . $this->template . '/js/jquery.main.js', 'text/javascript');
//$doc->addScript(JUri::base(true) . '/templates/' . $this->template . '/js/bootstrap.min.js', 'text/javascript');
...
<?php 
$doc->addScript(JUri::base(true) . '/media/system/js/language.js');
$doc->addScript(JUri::base(true) . '/media/jui/js/jquery.min.js', 'text/javascript');
$doc->addScript(JUri::base(true) . '/media/jui/js/jquery-noconflict.js', 'text/javascript');
$doc->addScript(JUri::base(true) . '/media/jui/js/jquery-migrate.min.js', 'text/javascript');
	?>
	...
	<div id="wrapper">
		...
		<!-- Nav tabs -->
			...
			<div class="tab-content">
				...
				<jdoc:include type="modules" name="right_fp1" style="xhtml" />
				</div>
				<div role="tabpanel" class="tab-pane" id="tab2">
				<jdoc:include type="modules" name="right_fp2" style="xhtml" />
					<a href="index.php?option=com_eventlist&amp;view=eventlist&amp;Itemid=39913" class="more"><?php echo JText::_('VIEW MORE'); ?></a>	</div>
			</div><!-- end of tab-content -->
		</div><!-- end of tabs-holder -->
				
					</div>
				</div>
				<jdoc:include type="modules" name="postmain" style="innerhtml" newposition="postlinks" />
...
<script src="<?php echo JUri::base(true) . '/templates/' . $this->template . '/js/bootstrap.min.js'; ?>"></script>
<script src="<?php echo JUri::base(true) . '/templates/' . $this->template . '/js/jquery.main.js'; ?>"></script>
