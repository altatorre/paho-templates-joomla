	...
	<tr valign="top" >
		<td width="50%">                                        	
			...
			<td background="<?php echo $mosConfig_live_site;?>/templates/paho_cms/images/spacer1.gif" bgcolor="silver" width="1" style="width:1px;"><img src="<?php echo $mosConfig_live_site;?>/templates/paho_cms/images/spacer1.gif" /></td>
								...
								<?php if ( $right > 0 ) { ?>
<td width="1" align="left" valign="top" class="line"><img src="http://www.who.int/sysmedia/images/shim.gif" alt="" width="1" height="1" /></td>
<td width="10"><img src="http://www.who.int/sysmedia/images/shim.gif" alt="" width="10" height="1" /></td>
...
<hr color="#CCCCCC" width="140" noshade="noshade" align="left" size="1"/>
        		                            <div id="right_inner_profile">
                                            	<?php mosLoadModules ( 'profiles', -2 ); ?>
                                            </div>
                                		</div>
				</div>
			</td>
